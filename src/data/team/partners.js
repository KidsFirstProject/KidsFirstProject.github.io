...
const images = importAll(
  require.context('../../assets/images/partners', false, /\.(png|jpe?g|gif)$/)
);
...
const partners = [
  ...
  },
  {
    ...
    description:
      'Girls Science Interactive is a youth-led nonprofit organization that provides free STEM summer camps and other programs for elementary and middle school girls to spark their interest in science.',
  ...
  },
  {
    ...
    name: 'Noble Hour',
    description:
      'NobleHour connects people with opportunities, tracks projects and service hours, and generates comprehensive and powerful impact reports.',
  ...
  },
  {
    ...
    name: 'PERIOD',
    description:
      'PERIOD is a non-profit group run by young activists. We are leading the Menstrual Movement by changing the conversation around periods and providing care to those in need.',
  ...
  },
  {
    ...
    ctaUrl:
      'http://www.pdx.edu/student-community-engagement/student-leaders-for-service-team-members'
  },
  {
  ...
  {
    imageUrl: images['SUNprogram.png'],
