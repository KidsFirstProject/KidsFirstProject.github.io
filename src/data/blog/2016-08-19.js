...
const Blog20160819 = {
  id: 20160819,
  title:
    'Understanding the Relationship between Poverty and Childhood Development: Learning Curve Model',
  type: 'text',
  ...
  body: [
    ...
    },
    {
      type: 'paragraph',
      text:
        'In order to obtain first hand data, I got in touch with Forest Park Elementary and Whitman Elementary through my former second grade teacher. On opposite sides of town, Forest Park and Whitman students have contrasting socioeconomic situations, creating a large disparity in terms of outside resources, support, and educational environments.'
    },
    {
      type: 'table',
      title: 'Brief Demographics of Forest Park and Whitman Elementary School',
      column_headers: ['Forest Park', 'Whitman'],
      data: [
        [
          'Very small number of students receive free or reduced lunch',
          '100% of students receive free or reduced lunch'
        ],
        [
          'Economically disadvantaged: 1.6%',
          'Economically disadvantaged: 57.9%'
        ],
        [
          <React.Fragment>
    ...
    },
    {
      type: 'paragraph',
      text:
        'In order to process the data, I used the unit learning curve equation by calculating trials independent of each other with cumulative and individual averages of words memorized.'
    },
    {
      type: 'paragraph',
      text:
        'By not showing the details of calculations, here I write down the results for drawing the conclusions.'
    },
    {
      type: 'paragraph',
      text:
        'Both Forest Park and Whitman students were able to memorize more words as more trials were performed, yet the average number of words memorized by Forest Park students was consistently higher than the average number of words memorized by Whitman students.'
    },
    {
      type: 'paragraph',
      text:
        'Difference between Forest Park and Whitman learning rates: 1.450-1.445 = .005 (insignificant)'
    },
    {
      type: 'heading',
      text: 'Conclusion'
