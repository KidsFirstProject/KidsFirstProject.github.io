...
const Blog20171006 = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Even though I\'m not sure what career path I would like to take after college, I see myself going to Wharton and double majoring in international business and corporate law, with a minor in political science. I\'ve also caught the entrepreneurship bug early on, so I hope to find a way to bring that along with my love for civics and law together to drive social change within my community.'
    },
    {
      type: 'strong',
      text: 'You have an entire day to yourself. Where do you go and what will you do?'
    },
    {
      type: 'paragraph',
      text: 'If I had a day to myself I would most likely curl up with some blankets, a book, music, and hot chocolate, and just spend the day reading. I will read anything someone puts in front of me (except those books from my English classes - that\'s what Sparknotes and Schmoop is for), but I especially love fantasy!'
    },
    {
      type: 'strong',
    ...
    {
      type: 'paragraph',
      text: 'Something most people don\'t know about me is that I prefer to wear heels over flats any day! I also live by the quote "Well-behaved women seldom make history", so I\'m always ready to kick-butt with my heels :)'
    },
    {
      type: 'strong',
