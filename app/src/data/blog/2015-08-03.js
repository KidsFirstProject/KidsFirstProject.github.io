...
const Blog20150803 = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'From catching a midnight plane from Portland to wandering around the Detroit airport at four in the morning, I had no idea just how big of an experience I was about to be a part of. From the start, I was greeted by an amazing atmosphere of exuberant mentors and excited fellows.'
    },
    {
      type: 'paragraph',
      text: 'The conference was absolutely life changing.'
    },
    {
      type: 'paragraph',
      text: 'I learned years worth of leadership and mentoring lessons in four short days, all thanks to the powerful network of ANNpower. If I were to write my entire experience, it would be more of a novel than a blog post, so I have compiled my top ten memories and lessons learned from the conference to share and hopefully inspire as much as it inspired me.'
    },
    {
      type: 'image',
      image: image2
    ...
    {
      type: 'heading',
      text: 'TOP TEN MEMORIES'
    },
    {
      type: 'list',
      ordered: true,
      data: [
        'Attending the Vital Voices Global Leadership Awards and post awards reception at The John F. Kennedy Center for Performing Arts. We listened to speakers like Bill Clinton, Diane Von Fostenburg, Jan Singer, and Elyse Nelson.',
