...
import { Container, Col, Row, Image, Button, Card, ResponsiveEmbed } from 'react-bootstrap';
        ...
        <Card className={styles.card}>
          ...
          <Card.Body>
            <Card.Text className="text-center">
              ...
              <a href="http://www.signupgenius.com/go/30e0c4faeaf2fa5f94-kids" target="_blank" rel="noopener noreferrer">
            ...
            <Card.Text>
              <div>
                ...
                <ul>
                  ...
                  <li>Complete a short online orientation about our organization (Attending in person orientation at shelter is highly recommended)</li>
                </ul>
              </div>
              <Button href="https://docs.google.com/forms/d/120QCcvp0nclc3Is8XMjf9XR7Mk5VwYx_I9CWe7YqaSU/viewform"><FontAwesomeIcon icon={faPen} color="white"/> Apply Now</Button>
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
    ...
    <Row>
      <Col className="d-flex flex-column justify-content-center align-items-center">
        ...
        <ResponsiveEmbed aspectRatio="16by9">
          <iframe title="New Volunteer Orientation Powerpoint" src="https://docs.google.com/presentation/d/1vyZS36uuGONWKj2Z1RYETjuxyH_0gwyFmz3rAxh7ZLE/embed?start=false&amp;loop=true&amp;delayms=10000" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" />
        </ResponsiveEmbed>
      </Col>
    </Row>
  </Container>
